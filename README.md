...
| 均衡优化 | FFE / DFE / CTLE · 浮动抽头搜索 · FFE+DFE 联合求解 (802.3dj 200G 光口 / CEI TP4 EECQ) · CTLE 旁路真值复核 · 网格搜索候选数上限 · 802.3 族预设携带抽头限值 · 优化摘要与事件提示 (不劣于优化前由终选保证) |
| 光眼 | 光眼图 · TDECQ · EECQ · 802.3dj D3.1 参考均衡器主方法 (15 FFE + 1 DFE, Table 180-16 限值) |
